...
{
    public class GeonBit_UI_Example : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            int _ScreenWidth = 1480;//graphics.GraphicsDevice.Adapter.CurrentDisplayMode.Width;
            int _ScreenHeight = 960;//graphics.GraphicsDevice.Adapter.CurrentDisplayMode.Height;
